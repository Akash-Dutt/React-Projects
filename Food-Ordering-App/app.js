...
//Part-1 Header
    ...
    //importing logo from local storage
    const logo = require('./images/logowithoutbg.png');
        ...
        return (
            <div className="header">
                <div className="logo-container">
                    <img className="logo" src={logo} alt="FoodChef Logo"/>
                </div>
...
//Part - 2 Body
    ...
    //Restaurant data in the form of - array of objects - this is how production data comes in the form of JSON from backend
    const RestaurantList = [
        ...
        },
        {
            ...
            "availability": {
                "nextCloseTime": "2024-04-20 02:59:00",
                "opened": true
            },
            "badges": {
                "imageBadges": [
